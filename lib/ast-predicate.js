...
/**
 * Represents the test whether a named path specifies a set of unique values
 * @class @extends PredicateNode
 */
function PathUniqueNode(pathNode) {
    this.child = util.checkarg(pathNode, ast.PathNode);
}
ast.AstNode.extend(PathUniqueNode, 'pathUnique', PredicateNode);
PathUniqueNode.prototype.attribs = function() { return [ 'child' ]; };
